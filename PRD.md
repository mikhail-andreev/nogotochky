...
Минималистичный дизайн на базе Bootstrap 5 с кастомной темой:

- **Шрифт**: Inter (Google Fonts)
- **Цветовая палитра**: тёплый терракот (#b07d62) как акцент, off-white фон (#faf9f7)
- **Компоненты**: скруглённые карточки, pill-бейджи, мягкие тени
- **Адаптивность**: mobile-first, таблицы заменяются карточками на экранах < 768px
- **Навбар**: светлый sticky-навбар
- **CSS-архитектура**: один файл `style.css` с CSS-переменными (design tokens)
